...
<drawing version="7">
    ...
    <netlist>
        ...
        <blockdef name="buf8">
            <timestamp>2015-9-30T9:49:13</timestamp>
        ...
        <block symbolname="IMux4x1x8" name="XLXI_142">
            ...
            <blockpin signalname="XLXN_1238" name="Present3" />
        ...
        <block symbolname="buf" name="XLXI_479">
        ...
        <block symbolname="ZeroByte" name="XLXI_497">
            <blockpin signalname="XLXN_1237(7:0)" name="ZeroData(7:0)" />
        </block>
    ...
    <sheet sheetnum="1" width="5440" height="3520">
        ...
        <branch name="PB_INt0">
            <wire x2="4864" y1="80" y2="80" x1="4848" />
            <wire x2="4928" y1="80" y2="80" x1="4864" />
        </branch>
        <instance x="4624" y="112" name="XLXI_479" orien="R0" />
        <branch name="presentFTDIControl">
        ...
        <branch name="pb_input_debug(7:0)">
            <wire x2="4896" y1="320" y2="320" x1="4880" />
            <wire x2="4944" y1="320" y2="320" x1="4896" />
        </branch>
        <branch name="DATA_OUT(15:0)">
            <wire x2="4944" y1="384" y2="384" x1="4800" />
        </branch>
        <instance x="4496" y="352" name="XLXI_485" orien="R0">
        </instance>
        <iomarker fontsize="28" x="4944" y="320" name="pb_input_debug(7:0)" orien="R0" />
        <iomarker fontsize="28" x="4944" y="384" name="DATA_OUT(15:0)" orien="R0" />
        <instance x="4624" y="176" name="XLXI_495" orien="R0" />
        <branch name="PB_INt1">
            <wire x2="4928" y1="144" y2="144" x1="4848" />
        </branch>
        <branch name="presentFTDIibus">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="4096" y="144" type="branch" />
            <wire x2="4608" y1="144" y2="144" x1="4096" />
            <wire x2="4624" y1="144" y2="144" x1="4608" />
        </branch>
        <iomarker fontsize="28" x="4928" y="144" name="PB_INt1" orien="R0" />
        <instance x="192" y="2000" name="XLXI_497" orien="R0">
        </instance>
        <branch name="XLXN_1237(7:0)">
            <wire x2="992" y1="1968" y2="1968" x1="512" />
        </branch>
        <branch name="XLXN_1238">
            <wire x2="528" y1="2032" y2="2048" x1="528" />
